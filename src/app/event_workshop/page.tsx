    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#091F46] to-[#37729C] text-[#E9E4DE]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <p className="text-lg">Discover our exciting events and join us for an unforgettable experience.</p>
        </div>
        <div
          className="p-8 bg-white bg-opacity-10 rounded-lg shadow-lg cursor-pointer hover:bg-opacity-20 transition transform hover:scale-105 duration-300 ease-in-out w-80 h-60"
        ...
        >
          ...
          <p className="text-lg">Participate in our interactive workshops and enhance your skills.</p>
        </div>
      </div>
    </div>
  );
